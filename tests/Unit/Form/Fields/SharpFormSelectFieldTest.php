...
class SharpFormSelectFieldTest extends SharpTestCase
{
    ...
    /** @test */
    public function we_can_define_multiple()
    {
    ...
    /** @test */
    public function we_can_define_inline()
    {
        $formField = $this->getDefaultSelect()
            ->setInline();
    ...
    /** @test */
    public function we_can_define_clearable()
    {
        $formField = $this->getDefaultSelect()
            ->setClearable(true);
    ...
    /** @test */
    public function we_can_define_display_as_list()
    {
        $formField = $this->getDefaultSelect()
            ->setDisplayAsList();
    ...
    /** @test */
    public function we_can_define_display_as_dropdown()
    {
        $formField = $this->getDefaultSelect()
    ...
    /** @test */
    public function we_can_define_options_as_a_id_label_array()
    {
        $formField = $this->getDefaultSelect([
            ['id' => 1, 'label' => 'Elem 1'],
            ['id' => 2, 'label' => 'Elem 2'],
    ...
    /** @test */
    public function we_can_define_options_as_a_custom_array()
    {
        $formField = $this->getDefaultSelect([
            ['key' => 'Elem-1'],
            ['key' => 'Elem-2'],
    ...
    /** @test */
    public function we_can_define_localized_options()
    {
        $formField = $this->getDefaultSelect([
    ...
    /** @test */
    public function we_can_define_localized_options_with_id_label_array()
    {
        $formField = $this->getDefaultSelect([
            ['id' => '1', 'label' => ['en' => 'Option one', 'fr' => 'Option un']],
            ['id' => '2', 'label' => ['en' => 'Option two', 'fr' => 'Option deux']],
    ...
    /** @test */
    public function we_can_define_linked_options_with_dynamic_attributes()
    {
        $formField = $this->getDefaultSelect([
            'A' => [
                'A1' => 'test A1',
    ...
    /** @test */
    public function we_can_define_linked_options_with_dynamic_attributes_and_localization()
    {
        $formField = $this->getDefaultSelect([
            'A' => [
    ...
    /** @test */
    public function we_can_define_linked_options_with_dynamic_attributes_on_multiple_master_fields()
    {
        $formField = $this->getDefaultSelect([
            'A' => [
                'A1' => [
