...
{
    /** @test */
    function we_can_format_datetime_value_to_front()
    {
    ...
    /** @test */
    function we_can_format_date_only_value_to_front()
    {
        $formatter = new DateFormatter;
        $field = SharpFormDateField::make("date");
        $field->setHasDate(true);
    ...
    /** @test */
    function we_can_format_time_only_value_to_front()
    {
        $formatter = new DateFormatter;
        $field = SharpFormDateField::make("date");
    ...
    /** @test */
    function we_can_format_datetime_value_from_front()
    {
        $formatter = new DateFormatter;
        $field = SharpFormDateField::make("date");
        $field->setHasDate(true);
    ...
    /** @test */
    function we_can_format_date_only_value_from_front()
    {
        $formatter = new DateFormatter;
        $field = SharpFormDateField::make("date");
        $field->setHasDate(true);
    ...
    /** @test */
    function we_can_format_time_only_value_from_front()
    {
        $formatter = new DateFormatter;
        $field = SharpFormDateField::make("date");
        $field->setHasDate(false);
