...
class BreadcrumbTest extends BaseApiTest
{
    ...
    public function previous_breadcrumb_item_is_updated_regarding_referer_to_manage_updated_querystring()
    {
        ...
        $this->get('/sharp/s-list/person');
        $this
            ->withHeader("Referer", url('/sharp/s-list/person?filter_type=4&page=2'))
        ...
        $this->assertEquals(
            [
                [
                    "type" => "entityList",
                    "url" => url('/sharp/s-list/person?filter_type=4&page=2'),
                    "name" => "List",
                    "entity_key" => "person"
                ], [
                    "type" => "show",
        ...
        $this->get('/sharp/s-list/person');
        $this
            ->withHeader("Referer", url('/sharp/s-list/spaceship'))
            ->get('/sharp/show/person/1?x-access-from=ui');
