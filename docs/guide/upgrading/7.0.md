...
update filter usage in query builder $this->queryParams->filterFor(**MyFilter::class**)
TODO

### New `buildFilterConfig()` method + removal of all old functions: `->isMaster()`, `->template()`...
