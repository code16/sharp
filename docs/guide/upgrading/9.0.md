...
## The API for embedded uploads in Editor field was rewritten, and `UPLOAD` / `UPLOAD_IMAGE` tools was removed from toolbar
    ...
    $this->addField(
        SharpFormEditorField::make('content')
            ...
            ->setToolbar([
                SharpFormEditorField::B,
                SharpFormEditorField::A,
                // SharpFormEditorField::UPLOAD, // This is no longer needed
            ])
...
## New method to handle deferred store operations in SharpForm
