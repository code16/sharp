...
If you have added `/public/sharp-assets/menu-icon.png` and/or `/public/sharp-assets/login-icon.png` images, you must ensure the path is defined in the `config/sharp.php` config file, with the new format:
...
return [
    ...
    'theme' => [
        // [...]
        'logo_url' => '/public/sharp-assets/login-icon.png',
    ],
];
```
