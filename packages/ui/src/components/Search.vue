<template>
    <div class="SharpActionBar__search SharpSearch SharpSearch--lg" :class="{'SharpSearch--active': localActive}" role="search">
        <form class="h-100" @submit.prevent="handleSubmitted">
            <label id="ab-search-label" class="SharpSearch__label" for="ab-search-input">{{ placeholder }}</label>
            ...
            <svg class="SharpSearch__close" :class="{ 'SharpSearch__close--hidden':!clearVisible }"
