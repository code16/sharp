...
class SharpFormUploadField extends SharpFormField implements IsUploadField
{
    ...
    {
        return $this->imageTransformKeepOriginal ?? sharpConfig()->get('uploads.transform_keep_original_image');
    }
    ...
    public function toArray(): array
    {
        return parent::buildArray([
            ...
            'maxFileSize' => $this->maxFileSize ?: sharpConfig()->get('uploads.max_file_size'),
    ...
    private function buildValidationRule(): array
    {
        ...
        $maxFileSizeInMB = $this->maxFileSize ?: sharpConfig()->get('uploads.max_file_size');
