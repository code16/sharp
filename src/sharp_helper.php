...
if (! function_exists('sharp_version')) {
    /**
     * @return string
     */
...
if (! function_exists('sharp_page_title')) {
    /**
...
if (! function_exists('sharp_has_ability')) {
    /**
...
if (! function_exists('sharp_check_ability')) {
    /**
     * @param string $ability
     * @param string $entityKey
     * @param string|null $instanceId
...
if (! function_exists('sharp_markdown_thumbnails')) {
    /**
...
if (! function_exists('sharp_custom_form_fields')) {
    /**
...
if (! function_exists('sharp_laravel_version_gte')) {
    /**
...
if (! function_exists('sharp_base_url_segment')) {
    /**
     * @return string
     */
